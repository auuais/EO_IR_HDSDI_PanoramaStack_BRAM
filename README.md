# EO IR HDSDI Panorama Stack BRAM
...
- Project file: `EO_IR_HDSDI_PanoramaStack_BRAM.xpr`
...
- EO stack keeps the proven decimated frame-buffer path in BRAM.
- IR frame buffers are packed into 64-bit UltraRAM words to fit both EO and IR functionality on-chip.
